...
| `/appointments` | `/book/` | — |
| `/contact` | `/contact/` | — |
| `/blog` | `/current-sky/archive/` | lunation posts live under Current Sky |
...
| `/blog/category/Lunations`, `/blog/category/New+Moon`, `/blog/category/Astrological+Transits`, all `/blog/tag/*` | `/current-sky/archive/` | consolidate |
