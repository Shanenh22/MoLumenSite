...
Use `npm run test:content` for MoLumen-specific business/content integrity. Keep CI, Pages CMS quality checks, scheduled health checks, and deploy validation aligned with the repository's current scripts.
