...
Mercury never moves backwards. Nothing in the solar system reverses direction.
...
does it three or four times a year, for roughly three weeks each time.

The astronomy here is not disputed by anyone. If an astrologer tells you Mercury is genuinely
reversing, that is a reason to find a different astrologer.
...
The conventional advice follows from that: a period better suited to revising than launching,
...
I take Mercury retrograde seriously as a scheduling consideration and not much more.

If I have a choice about when to sign something significant, launch something public, or buy a
computer, I would rather not do it in a retrograde window. Not because I expect sabotage, but
because the periods do seem to correlate with the mundane friction of things needing to be done
twice, and there is usually no cost to waiting three weeks.

What I do not do is cancel things, live in dread of it, or attribute every difficulty in a
three-week window to a planet. And I'd be cautious of anyone who does, because that framing sells
extremely well and helps almost nobody.

## What has been oversold

**That it causes technology to fail.** Devices fail constantly, in and out of retrograde. What
...
**That everyone is affected equally.** Whether a Mercury retrograde is meaningful for you depends
on where Mercury sits in your own chart, and what it rules there. For some people it barely
registers. For a Gemini or Virgo rising, whose chart Mercury governs, it is a more significant
visitor.

## The genuinely useful version
