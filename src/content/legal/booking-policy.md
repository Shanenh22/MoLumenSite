...
Cancel or reschedule **at least 48 hours** before your session and there is no charge. Inside 48
hours, what you paid is held as **credit toward a future session** rather than lost. Arrive up to 15
minutes late and we will use the time that remains. Live readings are recorded and the recording is
yours.
...
Life happens, and it rarely checks a calendar first.

You may reschedule **without charge up to 48 hours before** your session, using the link in your
...
**At least 48 hours before the session:** cancel for a full refund, returned by the original payment
...
Sessions end at their scheduled time, because someone else may be booked after you. Arriving late
shortens your reading rather than extending it.

If you arrive within **15 minutes** of the start time, we will use whatever time remains and make it
...
Most people find they hear things on a second listen that went straight past them the first time.

By booking, you consent to that recording. **If you would rather not be recorded, say so at booking
and we will not record.** Recordings are kept confidential and are never shared by Mo with anyone
else. Please do not publish or distribute a recording without written permission.
...
[prepare for your reading](/prepare-for-your-reading/) explains them. What we cannot do is refund a
completed reading because the birth data supplied was wrong.

For relationship readings we need the same details for both people, and your confirmation that the
other person is content for their details to be shared.
...
If you are unsure which reading you want, the [reading finder](/reading-finder/) takes about a
minute, or simply email and ask.

## Your information

Intake and birth information is used solely to prepare and deliver your reading. It is never sold,
never shared, and never used for marketing. The [privacy policy](/privacy/) sets out the detail,
including how to have it deleted.

## Questions

Email mo@molumen.com. Anything in this policy can be discussed, and most things can be worked out.
